...
export interface MediaTaskStatus {
  id: string;
  status: 'pending' | 'processing' | 'downloading' | 'extracted' | 'translating' | 'completed' | 'failed';
  progress: number;
  srtUrl?: string;
...
// Re-export realtime hook for convenience
// Use this if you want real-time updates instead of polling
export { useMediaTaskRealtime } from './use-media-task-realtime';
